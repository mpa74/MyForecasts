namespace MyForecasts.UITests;

public class Constants
{
    public readonly static string WebAssemblyDefaultUri = "http://localhost:5001/";
    public readonly static string iOSAppName = "com.companyname.MyForecasts";
    public readonly static string AndroidAppName = "com.companyname.MyForecasts";
